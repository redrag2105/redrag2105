...
![trophy](https://skillicons.dev/icons?i=java,gradle,arduino,react,c,cphusplus,idea,vscode,py,stackoverflow,git,github,postman,firebase,mongodb,supabase&perline=18)
<hr>
